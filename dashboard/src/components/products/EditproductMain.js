...
const EditProductMain = (props) => {
  ...
  useEffect(() => {
    if (successUpdate) {
      ...
      toast.success("Тауар жаңартылды", ToastObjects);
    } else {
      ...
      <section className="content-main" style={{ maxWidth: "1200px" }}>
        <form onSubmit={submitHandler}>
          <div className="content-header">
            ...
            <h2 className="content-title">Тауарды жаңарту парақшасы</h2>
            <div>
                  ...
                  {loading ? (
                    ...
                    <>
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          type="number"
                          placeholder="Тауардың бағасын енгізіңіз"
                          className="form-control"
                          id="product_price"
                          required
                          value={price}
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          type="number"
                          placeholder="Тауардың санын енгізіңіз"
                          className="form-control"
                          id="product_price"
                          required
                          value={countInStock}
